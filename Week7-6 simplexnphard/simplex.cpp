...
for minimize just negate it 
min (fn) = maximize (max- fn)
max flow can be solved using this , just formulate, capacity as constraints,another shortest path, matching
